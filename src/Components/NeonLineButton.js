...
const Container = styled.a`
    ...
    height: calc(${props => props.width ? props.width : "100px"}/2);
    ...
    @keyframes fill{
        ...
        100%{
            background-color: ${props => props.color ? props.color : "#21E9FE"};
            color: black;
            box-shadow: 0 0 60px ${props => props.color ? props.color : "#21E9FE"};
        }
    }
`;
